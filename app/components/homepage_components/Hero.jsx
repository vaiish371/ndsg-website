...
const Hero = () => {
  return (
    <section 
      id="home"
      className="w-full flex flex-row h-screen justify-start min-h-screen gap-10 max-container">
      <div className='relative lg:w-1/2 flex flex-col justify-center items-start w-full max-lg:padding-x' > 
      ...
      <div className='relative max-lg:hidden flex-1 flex justify-end items-end max-sm:justify-center'>
