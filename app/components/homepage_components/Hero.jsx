...
const Hero = () => {
  return (
    <section 
      id="home"
      className="w-full flex flex-row lg:h-screen h-1/2 justify-start gap-10 max-container">
      <div className='my-10 lg:w-1/2 flex flex-col justify-center items-start w-full max-lg:padding-x' > 
