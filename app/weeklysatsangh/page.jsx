  ...
  return (
    <main>
        ...
        <div className='max-container px-10'>
            <h1 className='font-caudex text-4xl max-md:text-3xl max-md:leading-8 font-bold'>Why Satsangh?</h1>
            ...
            <section className='flex flex-row max-sm:flex-col gap-10 justify-between'>
                <div className='w-1/2 max-sm:w-full flex flex-col gap-10'>
                    <div className=''>
                        ...
                        <ul className='px-5 font-inter text-black list-disc text-base max-sm:text-[10px] max-sm:leading-7 leading-8'>
