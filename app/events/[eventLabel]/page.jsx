    ...
    <main>
        <section className='max-container padding-y px-10 max-sm:p-8'>
          <div className='relative'>
            <h1 className='font-caudex text-4xl max-md:text-2xl max-sm:text-xl font-bold text-center'>{eventpics[params.eventLabel].title}</h1>
        ...
        <section>
          ...
          <div className='max-container px-10'>
              <h1 className='font-caudex text-4xl max-md:text-2xl max-md:leading-8 font-bold'>What are Madhurageethams?</h1>
              ...
              <div className='padding-y'>
                <h1 className='font-caudex text-4xl max-md:text-2xl max-md:leading-8 font-bold'>
                  Winners of 2023
                </h1>
